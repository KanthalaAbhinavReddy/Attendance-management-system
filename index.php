...
<body class="bg-gradient-login" style="background-image: url('img/YxRayv.jpeg');">
    <!-- Login Content -->
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <div class="text-center">
                                        <img src="img/logo/logo1.png" style="width:100px;height:100px">
                                        <br><br>
                                        <h1 class="h4 text-gray-900 mb-4"><b>Login</h1>
                                    </div>
